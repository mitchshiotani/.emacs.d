...
(let* ((variable-tuple
	...
	(headline           `(:inherit default :weight bold :foreground "pink")))
(custom-theme-set-faces
    ...
    `(org-level-4 ((t (,@headline ,@variable-tuple :height 1.1 :foreground "light yellow"))))
    `(org-level-3 ((t (,@headline ,@variable-tuple :height 1.25 :foreground "light green"))))
    `(org-level-2 ((t (,@headline ,@variable-tuple :height 1.5 :foreground "light blue"))))
...
(global-set-key (kbd "C-c C-;") 'projectile-commander)
...
;; pomodoro
(setq org-clock-sound "~/Music/epic.wav")
...
;visible bell (https://www.emacswiki.org/emacs/AlarmBell)
